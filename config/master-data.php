...
return [
    ...
    |
    | Salah/Jamaat and Quran are provisioned independently (AttendanceReasonType)
    | so a Company Admin can diverge one list from the other later without it
    | looking like a bug. They start identical; nothing keeps them that way.
    |
    */
