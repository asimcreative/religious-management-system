...
return [
    ...
    'attendance_reasons_intro' => 'Reasons available when someone is not present.',
    'no_attendance_reasons_title' => 'Only "Present" can be recorded',
    'no_attendance_reasons_text' => 'This company has no active attendance reasons, so absences and leave cannot be marked.',
    ...
    'reason_use_1' => 'Appears in the status dropdown on both attendance sheets.',
