...
return [
    ...
    // Admission form
    'admission_form' => 'Quran Class Admission Form',
    'admission_subtitle' => 'Admission details for :name — save them now, or skip and fill them in later.',
    'back_to_members' => 'Back to Members',
    'employee_information' => 'Employee Information',
    'quran_class_information' => 'Quran Class Information',
    'quran_class_type' => 'Quran Class Type',
    'assigned_teacher' => 'Assigned Teacher',
    'current_reading_level' => 'Current Reading Level',
    'current_reading_level_help' => 'A rating from 1 (just starting) to 10 (near fluent).',
    'previously_completed_quran' => 'Has the Employee Previously Completed the Quran?',
    'admission_date' => 'Admission Date',
    'classes_per_week' => 'Classes Per Week',
    'days_5' => '5 Days',
    'days_6' => '6 Days',
    'current_starting_point' => 'Current Starting Point',
    'current_starting_point_help' => 'Fill in whichever applies to the Quran Class Type selected above.',
    'lesson_no' => 'Lesson No. (Qaida)',
    'juz_no' => 'Juz No. (Nazirah)',
    'surah' => 'Surah (Hifz)',
    'remarks' => 'Remarks',
    'admission_guidance_title' => 'About this form',
    'admission_guidance_1' => 'Employee and class details are pre-filled — nothing here needs to be re-typed.',
    'admission_guidance_2' => 'The reading position you set also becomes the employee\'s Quran Progress record.',
    'admission_guidance_3' => 'Skipping is fine — the member is already added, and this can be filled in any time from the members list.',
    'save_admission' => 'Save Admission',
    'skip_for_now' => 'Skip for now',
    'admission_saved' => 'Admission details saved successfully.',
    'admission_pending' => 'Admission Pending',
    'admission_complete' => 'Admission Complete',
    'fill_admission_form' => 'Fill Admission Form',
];
