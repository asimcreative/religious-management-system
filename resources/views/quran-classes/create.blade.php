...
<div class="d-flex justify-content-between align-items-center mb-3">
    <h4 class="mb-0">{{ __('quran_classes.create_class') }}</h4>
...
<form method="POST" action="{{ route('quran-classes.store') }}">
    @csrf
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" id="max_strength" name="max_strength" class="form-control @error('max_strength') is-invalid @enderror"
                           value="{{ old('max_strength', 25) }}" min="1" max="999" required>
    ...
    <div class="d-flex gap-2">
        ...
        <a href="{{ route('quran-classes.index') }}" class="btn btn-outline-secondary">{{ __('quran_classes.cancel') }}</a>
    </div>
</form>
@endsection
