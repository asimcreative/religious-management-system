...
@section('title', __('masters.salah_attendance_reasons'))

@section('breadcrumbs')
    <li class="breadcrumb-item">{{ __('masters.master_data') }}</li>
    <li class="breadcrumb-item active" aria-current="page">{{ __('masters.salah_attendance_reasons') }}</li>
@endsection

@section('content')
@include('masters.partials.index', [
    'title' => __('masters.salah_attendance_reasons'),
    ...
    'transferResource' => 'salah-attendance-reasons',
